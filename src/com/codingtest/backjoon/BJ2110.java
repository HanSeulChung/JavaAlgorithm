...
//            wifis[i] = sc.nextInt();
//        }
//        //System.out.println(Arrays.toString(wifis));
//        Arrays.sort(wifis);
//        //System.out.println(Arrays.toString(wifis));
//
//        int minV = wifis[0];
//        int maxV = wifis[wifis.length - 1];
//
//        int[] mindistance = new int[wifis.length - 2];
//        int idx = 0;
//        int answer = Integer.MIN_VALUE;
//        for (int i = 1; i < wifis.length - 1; i++) {
//            int a = wifis[i] - minV;
//            int b = maxV - wifis[i];
//            mindistance[idx] = a < b ? a : b;
//            if (mindistance[idx] > answer) {
