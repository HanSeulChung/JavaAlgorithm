...
class Node {
    ...
    Node(int key, NodeAVL left, NodeAVL right) {
        this.key = key;
        this.left = left;
        this.right = right;
    }
...
class BinarySearchTree {
        ...
        if(this.head==null){
            ...
            while(true){
                ...
                if(key < cur.key){
                    ...
                    if(cur == null){
                        pre.left = new NodeAVL(key, null, null);
                        break;
                    }
                } else {
                    cur = cur.right;
                    ...
                    if(cur ==null){
                        pre.right = new NodeAVL(key, null, null);
                        break;
                    }
                }
            }
    ...
    public void removeNode(int key) {
        ...
        if(cur.left == null && cur.right == null){ // Leaf 노드인경우
            if(parent==null){
                this.head =null;
            } else {
                if(parent.left ==cur){
