package com.lecture.알고리즘.minimumSpanningTree.practices;
...
public class Practice2 {
    ...
    static ArrayList<Node>[] graph;  // ArrayList<ArrayList<Node>>를 배열로 구성한 것  왜 이렇게 구성했을까?
    ...
    public static void solution(int v, int e, int[][] data) {
        ...
        for (int i = 0; i < e; i++) {
            ...
            graph[data[i][0]].add(new Node(data[i][0], data[i][2]));
        }
